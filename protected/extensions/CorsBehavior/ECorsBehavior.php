...
class ECorsBehavior extends CBehavior

{
    ...
    {
//        var_dump(parent::events());

        return array('onBeginRequest' => 'onBeginRequestHandler');

    }

    

    public function onBeginRequestHandler1($event)
