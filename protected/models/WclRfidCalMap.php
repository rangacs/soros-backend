 ...
 */
class WclRfidCalMap extends CActiveRecord
{
	/**
	 ...
	 * @return WclRfidCalMap the static model class
	 */
    ...
    public static function findActiveCalibFile($itmCode){
        
        $calEntryExits =  WclRfidCalMap::model()->exists(" wcl_item_code ='$itmCode'");
        
        if($calEntryExits){
            $model = WclRfidCalMap::model()->find(" wcl_item_code ='$itmCode'");
            return $model->wcl_sabia_cal_name;
        }else{
            return "N/A";
        }//else
    }//public
