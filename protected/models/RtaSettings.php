...
/**
 * This is the model class for table "rta_settings".
 *
 * The followings are the available columns in table 'rta_settings':
 * @property string $varName
 * @property string $varKey
 * @property string $varValue
 */
class RtaSettings extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('varKey, varValue', 'length', 'max'=>200),
	 ...
	 * @return RtaSettings the static model class
	 */
