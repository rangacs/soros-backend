 ...
 * @property double $K
 */
class TagCompleted extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('avgMassFlowTph, totalTons, Ash, Sulfur, Moisture, BTU, Na2O, SO2, TPH, SiO2, Al2O3, Fe2O3, TEST, CAL_ID, MAFBTU, CaO, MgO, K2O, TiO2, Mn2O3, P2O5, SO3, Cl, LOI, LSF, SM, IM, C4AF, NAEQ, C3S, C3A, SourceDeployed, SourceStored, K', 'numerical'),
            ...
            array('tagID, rtaMasterID, status, tagName, tagGroupID, LocalstartTime, LocalendTime, goodDataSecondsWeight, massflowWeight, validTag, endTic, startTic, goodDataSecs, avgMassFlowTph, totalTons, Ash, Sulfur, Moisture, BTU, Na2O, SO2, TPH, SiO2, Al2O3, Fe2O3, TEST, CAL_ID, MAFBTU, CaO, MgO, K2O, TiO2, Mn2O3, P2O5, SO3, Cl, LOI, LSF, SM, IM, C4AF, NAEQ, C3S, C3A, SourceDeployed, SourceStored, K', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return TagCompleted the static model class
     */
