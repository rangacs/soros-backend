...
class RtaPhysicalConfigController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['RtaPhysicalConfig']))
		{
			$model->attributes=$_POST['RtaPhysicalConfig'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->rta_ID_physical));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('RtaPhysicalConfig');
