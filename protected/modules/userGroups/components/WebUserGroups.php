...
class WebUserGroups extends CWebUser
{
  /*
  *  Abhinandan. 
  *   Here you can add more items to the WebUserGroups array 
  *    when you call:  $this->fb( Yii::app()->user );
  *    
  *    The config/main.php is set up to point to 'users'=>array... WebUserGroups class.     
  *
  */
