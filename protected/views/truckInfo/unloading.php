...
<section class="main-section grid_8">
	...
	$apiSabiaEndPoint = RmSettings::getValueFromKey('SABIA_API_ENDPOINT', 'Y-m-d H:i:s');
	//echo "--" . $apiSabiaEndPoint;exit();
?>
    </nav>
            ...
            <section class="container_6 clearfix">
                ...
                <div class="grid_6 leading">
                    <header class="ui-widget-header ui-corner-top form padding-5"> 
                        <h3 style="padding-left:10px;"> Unloading Confirmation</h3>
                    </header>
                ...
                <form id="truck_info_form" action="" method="post" class="form ">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="form-input">
                            ...
                            <input size="30" maxlength="30" name="wcl_trip_id" id="w_tripID" type="text">      
                        </div>
                    </div>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="form-input">
                            ...
                            <input size="30" maxlength="30" name="wcl_veh_no" id="w_vehNo" type="text">      
                        </div>
                    </div>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="form-input">
                            ...
                            <input size="30" maxlength="30" name="wcl_pl_code" id="w_plantCode" type="text">      
                        </div>
                    </div>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="form-input">
                            ...
                            <input size="30" maxlength="30" name="wcl_unl_id" id="w_unloaderID" type="text">      
                        </div>
                    </div>
                                        <div class="clearfix">

                        <label class="form-label" for="form-name">Trigger Type<em>*</em></label>

                        <div class="form-input dropdownListCss">

                            
                            <input type="text" id="w_trigType"  name="w_trigType" value="PB-3"/>
                            
                            <select class="form-input" name="w_unloadConf" id="w_unloadConf">
                                <option value="3">Full Unload</option>
                                <option value="4">Partial Unload</option>
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    window.onload = function () {
        ...
        $("#truck_info_form").live("submit", function (e) {
            ...
            axios.post(url, {
                evntTruckUnLoEndInfo: json_data,
                
            }).then(function (response) {
                console.log(response);
		alert("Truck Unloading Completed.");
